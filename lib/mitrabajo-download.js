...
async function downloadMitrabajo(targetDate, options = {}) {
  ...
  // Sin esto, headless usa chrome-headless-shell aparte; en Railway a veces falta ese binario
  // aunque el install de Chromium completo sí esté (error chromium_headless_shell-*).
