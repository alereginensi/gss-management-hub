...
console.log(' Test Data Cleanup Script (Fixed)\n');
...
if (testTicketIds.length > 0) {
 console.log('1⃣ Removing test tickets and related data...');
...
if (usersToDelete.length > 0) {
 console.log('2⃣ Removing user collaborations...');
 ...
 console.log('3⃣ Removing user notifications...');
 usersToDelete.forEach(user => {
 ...
 console.log('4⃣ Removing assigned tasks...');
 usersToDelete.forEach(user => {
 ...
 console.log('5⃣ Removing supervisor-worker relationships...');
 usersToDelete.forEach(user => {
 ...
 console.log('6⃣ Removing logbook entries...');
 usersToDelete.forEach(user => {
...
if (remainingTestUsers.length === 0) {
 ...
 console.log(` ${remainingTestUsers.length} potential test users still found:`);
